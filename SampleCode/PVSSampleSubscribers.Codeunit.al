Codeunit 69012 "PVS Sample Subscribers"
{
    trigger OnRun()
    begin
    ...
    [EventSubscriber(ObjectType::Table, 6010313, 'OnAfterValidate_Price_Method', '', true, false)]

    procedure OnAfterValidate_Price_Method(var in_Rec: Record "PVS Job");
    var
        KPI_Value1: Decimal;
        KPI_Value2: Decimal;
        KPI_Value3: Decimal;
